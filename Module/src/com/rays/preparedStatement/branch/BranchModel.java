	...
	// ------------------create table------------------------------
		public void create() throws SQLException {
			...
			try {
				...
				PreparedStatement pstmt = conn.prepareStatement("Create table branch(branchId int primary key,branchName varchar(45),city varchar(45),managerName varchar(45),contactNo bigint)");
				pstmt.executeUpdate();
				conn.commit();
		...
		public void insert(BranchBean bean) throws SQLException {
			Connection conn = null;
			try {
				conn = JDBCDataSource.getConnection();
				conn.setAutoCommit(false);
